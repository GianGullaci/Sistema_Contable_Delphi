object FListadoComprobantes: TFListadoComprobantes
  Left = 1067
  Top = 423
  Width = 830
  Height = 399
  Caption = 'Reporte Listado Comprobantes'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object QuickRepComprobantes: TQuickRep
    Left = 0
    Top = 1
    Width = 794
    Height = 1123
    ...
    BeforePrint = QuickRepComprobantesBeforePrint
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = 'Arial'
    ...
    Functions.DATA = (
      ...
      '0'
      #39#39)
    OnNeedData = QuickRepComprobantesNeedData
    ...
    object BandInfo: TQRBand
      ...
      object LabelTitCuenta: TQRLabel
        Left = 104
        Top = 0
        Width = 129
        Height = 25
