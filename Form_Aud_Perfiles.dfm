object FAudPerfiles: TFAudPerfiles
  Left = 974
  Top = 447
  Width = 927
  Height = 570
  Caption = 'Auditoria Perfiles'
  Color = clBtnFace
  ...
  object ListadoAudPerfiles: TStringGrid
    Left = 48
    Top = 56
    Width = 817
    Height = 377
  ...
  object BSalirAudPerfiles: TButton
    Left = 736
    Top = 457
    Width = 129
    Height = 33
    ...
    ParentFont = False
    TabOrder = 1
    OnClick = BSalirAudPerfilesClick
  end
