object FReporteAsientos: TFReporteAsientos
  Left = 415
  Top = 751
  Width = 828
  Height = 250
  Caption = 'Reporte Asientos'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object QuickRepAsientos: TQuickRep
    Left = 0
    Top = 0
    Width = 794
    Height = 1123
    ...
    BeforePrint = QuickRepAsientosBeforePrint
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = 'Arial'
    ...
    Functions.DATA = (
      ...
      '0'
      #39#39)
    OnNeedData = QuickRepAsientosNeedData
    ...
    object QRBand_Cuerpo: TQRBand
      ...
      object LabelFechaAsiento: TQRLabel
        Left = 48
        Top = 16
        Width = 73
        Height = 25
      ...
      object LabelRegistrado: TQRLabel
        Left = 344
        Top = 16
        Width = 73
        Height = 25
    ...
    object QRSubDetail_Operaciones: TQRSubDetail
      ...
      object LabelNombreCuenta: TQRLabel
        Left = 88
        Top = 8
        Width = 161
        Height = 25
